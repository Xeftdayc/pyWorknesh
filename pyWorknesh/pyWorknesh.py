...
def modAsistencia():
    ...
    lbBusqueda.grid(row=0, sticky="e")
    lbCodigo = Label(Form, text = "Codigo:", font=('arial', 14), bd=15)
    lbCodigo.grid(row=6, sticky="e",column=0)
    lbNombre = Label(Form, text = "Nombre:", font=('arial', 14), bd=15)
    lbNombre.grid(row=6, sticky="e",column=1)
    lbPaterno = Label(Form, text = "Apellido Paterno:", font=('arial', 14), bd=15)
    lbPaterno.grid(row=6, sticky="e",column=2)
    lbTIC = Label(Form, text = "TIC:", font=('arial', 14), bd=15)
    lbTIC.grid(row=8, sticky="e",column=0)
    lbANG = Label(Form, text = "ANG:", font=('arial', 14), bd=15)
    lbANG.grid(row=8, sticky="e",column=1)
    lbANT = Label(Form, text = "ANT:", font=('arial', 14), bd=15)
    lbANT.grid(row=8, sticky="e",column=2)
    lbl_text = Label(Form)
    lbl_text.grid(row=12, columnspan=3)
    ...
    tbBusqueda.grid(row=0, column=1)
    tbCodigo = Entry(Form, textvariable=tbCodigo, font=(14))
    tbCodigo.grid(row=7, column=0)
    tbNombre = Entry(Form, textvariable=tbNombre, font=(14))
    tbNombre.grid(row=7, column=1)
    tbPaterno = Entry(Form, textvariable=tbPaterno, font=(14))
    tbPaterno.grid(row=7, column=2)
    tbTIC = Entry(Form, textvariable=tbTIC, font=(14))
    tbTIC.grid(row=10, column=0)
    tbANG = Entry(Form, textvariable=tbANG, font=(14))
    tbANG.grid(row=10, column=1)
    tbANT = Entry(Form, textvariable=tbANT, font=(14))
    tbANT.grid(row=10, column=2)
